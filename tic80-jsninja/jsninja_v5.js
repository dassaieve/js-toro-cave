...
#jsninja v5
##feito:
- Reformei de 4 para 6 grupos de tiles para geracao procedural de terreno tipo marching squares ortogonais, copiados dos toromaze_v6 e jsperlinmc_v7;
- Um pouco mais de mapa feito manualmente;
...
##Todo:
- Implementar geracao procedural do mapa com gradient noise, labirinto e marching squares;
...
friction= 0.85 ;
floor   = 120  ;
precisao = 997; // 4 e 997 funcionam
