...
#jsninja v3
##feito:
- Reposicionei a resoluo do CoyoteJump dentro do player.Update;
- Na coliso player x mapa ao cair o coyote_ct zera
- Retirei codigos comentados desnecessarios

##bugs:
- colisao: ao escorregar de um bloco pode-se ficar colado na parede;
- para ty 0 1 2 4 8 16 ... tela fica com flicker; problema do arredondamento de numero flutuante;
- colisao: para ty negativo no esta funcionando

##Todo:
- Limitar x e y para funcionar circularmente dentro dos limites (240x8) e (136x8);
